...
from BEGE_GARCH.BEGE_GARCH import BEGE_ConstantNFullGJR_MLE
...
def run_seed(
    ...
    run_seed_estimation(
        estimator=BEGE_ConstantNFullGJR_MLE,
        model_label="ConstantN BEGE",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Constant-n Full BEGE-GARCH random-search estimation")
