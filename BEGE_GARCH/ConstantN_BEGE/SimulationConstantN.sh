...
ACTION_NAME="ConstantN_BEGE_RandomSearch"
PY_SCRIPT="${SCRIPT_DIR}/BEGE_constant_n1.py"
COLLECT_SCRIPT="${SCRIPT_DIR}/collect_constant_n_results.py"
...
Usage:
  ...
  bash ${0} estimate  Print optimizer-start counts.
...
estimate_runtime() {
    ...
    echo "ConstantN BEGE estimates full GJR dynamics for p_t and keeps n_t constant."
}
