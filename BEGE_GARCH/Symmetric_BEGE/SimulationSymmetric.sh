...
ACTION_NAME="Symmetric_BEGE_RandomSearch"
PY_SCRIPT="${SCRIPT_DIR}/BEGE_symmetric1.py"
COLLECT_SCRIPT="${SCRIPT_DIR}/collect_symmetric_results.py"
...
estimate_runtime() {
    ...
    echo "Symmetric BEGE has fewer volatility parameters than Full BEGE."
}
