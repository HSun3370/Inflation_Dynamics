...
from BEGE_GARCH.BEGE_GARCH import BEGE_ConstantPFullGJR_MLE
...
def run_seed(
    ...
    run_seed_estimation(
        estimator=BEGE_ConstantPFullGJR_MLE,
        model_label="ConstantP BEGE",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Constant-p Full BEGE-GARCH random-search estimation")
