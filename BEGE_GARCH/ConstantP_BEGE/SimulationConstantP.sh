...
ACTION_NAME="ConstantP_BEGE_RandomSearch"
PY_SCRIPT="${SCRIPT_DIR}/BEGE_constant_p1.py"
COLLECT_SCRIPT="${SCRIPT_DIR}/collect_constant_p_results.py"
...
estimate_runtime() {
    ...
    echo "ConstantP BEGE estimates full GJR dynamics for n_t and keeps p_t constant."
}
