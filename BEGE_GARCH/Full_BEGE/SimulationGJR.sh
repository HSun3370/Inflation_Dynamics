...
ACTION_NAME="Full_BEGE_RandomSearch"
PY_SCRIPT="${SCRIPT_DIR}/BEGE_GJR1.py"
...
estimate_runtime() {
    ...
    echo "Full BEGE has the largest volatility parameter block, so it may be slower than BadGood."
}
