...
The same four mean models estimated on the monthly effective sample (1969M2--2026M5, 688 observations; see the Monthly Data section of the Data Summary) are reported in `OLS_Results_Monthly.md`, generated by `LinearRegressions_Monthly.py` with HAC(12) standard errors. At the monthly frequency ARX(1,1) is preferred by both AIC and BIC; the additional inflation and SPF lags in ARX(2,1) and ARX(2,2) are individually insignificant.
